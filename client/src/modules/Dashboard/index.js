...
const Dashboard = () => {
	...
	return (
		...
		<div className='w-full lg:w-[25%] h-screen bg-slate-200'>
		<div className='w-full h-38 border-b-2 border-black bg-blue-200 pt-2 rounded-lg'> 
		  <div className='flex items-center my-8 mx-5'>
			<div className='w-36'>
			  <img src={Img1} className='border border-primary p-[2px] rounded-full' />
			</div>
			<div className='ml-8 w-max'>
			  <h3 className='text-2xl w-max text-black font-bold'>{user?.fullName}</h3>
			...
			<div>
			  {
				conversations.length > 0 ? 
				  conversations.map(({ conversationId, user }) => (
					<div className='flex items-center py-6 border-b-2 border-black border-b-gray-300'>
		...
		<div className="w-full lg:w-[50%] h-screen bg-white flex flex-col items-center overflow-hidden">
		  {
			messages?.receiver?.fullName &&
			<div className='w-[75%] bg-blue-200 h-[80px] my-14 rounded-full flex items-center px-14 py-2'>
		  ...
		  <div className='flex flex-col h-[75%] w-full overflow-y-auto shadow-sm'>
			<div className='p-14'>
			  {
		  ...
		  {
			messages?.receiver?.fullName &&
			<div className='p-10 w-full flex items-center border-t'>
		...
		<div className='w-full lg:w-[25%] h-screen bg-green-100 px-8 py-16 overflow-y-auto'>
		  ...
		  <div>
			{
			  users.length > 0 ?
				users.map(({ userId, user }) => {
				  return (
					<div key={userId} className='flex items-center py-6 border-b-2 border-black border-b-gray-300'>
